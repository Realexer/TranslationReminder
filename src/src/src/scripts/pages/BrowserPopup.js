		...
		Register.settingsManager.getSettings(function(settings) 
		{
			chrome.tabs.query({ active: true, currentWindow: true }, function(tabs) 
			{
				...
				Messanger.sendMessageToTab(currentTab.id, Messages.FE.GetSiteInfo, null, function(siteInfo) 
				{
					...
					UIManager.setChecked(replaceHighlightsWithTranslationsCheckbox, settings[SettingsKeys.ReplacingHighlightsWithTranslationEnabled]);

					UIManager.addEventNoDefault(replaceHighlightsWithTranslationsCheckbox, "change", function() 
					{
						Register.settingsManager.setReplacingHighlightsWithTranslationEnabled(UIManager.isChecked(replaceHighlightsWithTranslationsCheckbox), function() 
						{
							Messanger.sendMessageToTab(currentTab.id, Messages.FE.SwitchReplacingHighlightsWithTranslations, null, function() {
